Shader "Custom/GratingWall"
{
    Properties
    {
        // Zone 1
        _BarFrequency1 ("Bar Frequency Zone 1", Range(1, 100)) = 10
        _BarWidth1 ("Bar Width Zone 1", Range(0.01, 1)) = 0.1
        ...
        _EffectEnd1 ("Effect End Zone 1", Range(0, 1)) = 0.33
        _GratingRotation1 ("Grating Rotation Zone 1", Range(0, 360)) = 0.0

        // Zone 2
        _BarFrequency2 ("Bar Frequency Zone 2", Range(1, 100)) = 10
        _BarWidth2 ("Bar Width Zone 2", Range(0.01, 1)) = 0.1
        _BarColor2 ("Bar Color Zone 2", Color) = (0,0,1,1)
        _BackgroundColor2 ("Background Color Zone 2", Color) = (0.5,0.5,0.5,1)
        _EffectStart2 ("Effect Start Zone 2", Range(0, 1)) = 0.34
        _EffectEnd2 ("Effect End Zone 2", Range(0, 1)) = 0.67
        _GratingRotation2 ("Grating Rotation Zone 2", Range(0, 360)) = 45.0

        // Zone 3
        _BarFrequency3 ("Bar Frequency Zone 3", Range(1, 100)) = 10
        _BarWidth3 ("Bar Width Zone 3", Range(0.01, 1)) = 0.1
        _BarColor3 ("Bar Color Zone 3", Color) = (0,0,1,1)
        _BackgroundColor3 ("Background Color Zone 3", Color) = (0.5,0.5,0.5,1)
        _EffectStart3 ("Effect Start Zone 3", Range(0, 1)) = 0.68
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                bool withinZone1 = i.uv.x >= _EffectStart1 && i.uv.x <= _EffectEnd1;
                bool withinZone2 = i.uv.x >= _EffectStart2 && i.uv.x <= _EffectEnd2;
                bool withinZone3 = i.uv.x >= _EffectStart3 && i.uv.x <= _EffectEnd3;
