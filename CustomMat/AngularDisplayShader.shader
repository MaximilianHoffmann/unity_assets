            ...
            half4 frag (v2f i) : SV_Target {
                ...
                if (inZone2) {   
                    if (_SwitchOnGrating2>0.5) {
                          ...
                          gratingColor = _Color2;
                        }
                            }

                   
                if (abs(i.localPos.y) > _CapThreshold) { // Changed to localPos
                    gratingColor.a = 0;
                }
