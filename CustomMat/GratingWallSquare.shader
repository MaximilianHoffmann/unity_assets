Shader "Custom/GratingWallSqaure"
{
    Properties
    {
        // Zone 1
        ...
        _EffectEnd1 ("Effect End Zone 1", Range(0, 1)) = 0.25
        ...
        _EffectStart2 ("Effect Start Zone 2", Range(0, 1)) = 0.25
        _EffectEnd2 ("Effect End Zone 2", Range(0, 1)) = 0.5
        ...
        _EffectStart3 ("Effect Start Zone 3", Range(0, 1)) = 0.5
        _EffectEnd3 ("Effect End Zone 3", Range(0, 1)) = 0.75
        _GratingRotation3 ("Grating Rotation Zone 3", Range(0, 360)) = 90.0

        // Zone 4
        _BarFrequency4 ("Bar Frequency Zone 4", Range(1, 100)) = 9
        _BarWidth4 ("Bar Width Zone 4", Range(0.01, 1)) = 0.5
        _BarColor4 ("Bar Color Zone 4", Color) = (0,0,1,1)
        _BackgroundColor4 ("Background Color Zone 4", Color) = (0.5,0.5,0.5,1)
        _EffectStart4 ("Effect Start Zone 4", Range(0, 1)) = 0.75
        _EffectEnd4 ("Effect End Zone 4", Range(0, 1)) = 1.0
        _GratingRotation4 ("Grating Rotation Zone 4", Range(0, 360)) = 90.0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            float _BarFrequency4;
            float _BarWidth4;
            float4 _BarColor4;
            float4 _BackgroundColor4;
            float _EffectStart4;
            float _EffectEnd4;
            float _GratingRotation4;
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float radians4 = _GratingRotation4 * 3.14159265359 / 180.0;
                ...
                bool withinZone4 = i.uv.y >= _EffectStart4 && i.uv.y <= _EffectEnd4;
                ...
                // Zone 4
                float2 uv_rotated4;
                uv_rotated4.x = uv_centered.x * cos(radians4) - uv_centered.y * sin(radians4);
                uv_rotated4.y = uv_centered.x * sin(radians4) + uv_centered.y * cos(radians4);
                uv_rotated4 += 0.5;
                ...
                uv_rotated4.x = frac(uv_rotated4.x);
                ...
                float barPattern4 = withinZone4 ? abs(frac(uv_rotated4.x * _BarFrequency4) - 0.5) / (0.5 * _BarWidth4) : 0.0;
                ...
                {
                    finalColor = lerp(_BackgroundColor4, _BarColor4, step(barPattern4, 1.0));
                }
                else
                {
